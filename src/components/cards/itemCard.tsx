...
export const ParallaxCard = ({ item, sx, onClick }: ParallaxCardType) => {
    return (
        <div className={` bg-white dark:bg-slate-800 overflow-hidden shadow-md transition-all duration-200 cursor-pointer grid grid-rows-12 p-2 rounded ${sx ? sx : ""}`} onClick={() => onClick && onClick()}>
